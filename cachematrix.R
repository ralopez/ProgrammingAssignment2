...
## The following function takes a matrix and creates a list containing functions to 
## set and get the values of the matrix (functions "set" and "get"), and to set and get 
